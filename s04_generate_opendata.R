...
df_history_mut <- df_history |>
  ...
  transmute(
    ...
    vendor_name = str_replace(vendor_name, "N/A", "None"),
    ...
    updated = str_replace(updated, "N/A", "Created in CY2023"),
    updated_desc = updated_desc,
    vendor_desc = vendor_desc,
    data = data,
    vendor = str_replace(vendor, "N/A", "None"),
    purpose_type = NA,
...
df_mut <- df_raw |>
  transmute(
    ...
    data_input = data_input,
    data_output = data_output,
    vendor_name = replace_na(vendor_name, "None"),
    ...
    updated = str_replace(updated, "Tool created in CY2024", "Created in CY2024"),
    updated_desc = updated_desc,
    vendor_desc = vendor_desc,
    data = NA,
    vendor = NA,
